...
function Tweet({ tweet }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const comment: CommentBody = {
      ...
      profileImg:
        session?.user?.image ||
        "https://images.squarespace-cdn.com/content/v1/5e0e65adcd39ed279a0402fd/1627422661797-QIMOL76SO962XLBHNZDU/7.jpg?format=2500w",
    };
    ...
    console.log("yay we did it", result);
